...
from utils.database import save_multi_file

multi_uploads = {}

async def multi_genlink_handler(client, message: Message):
    ...
    if message.document or message.video or message.audio:
        ...
        if len(files) >= 15:
            return await message.reply_text("🚫 Limit reached! 15 files max.")
